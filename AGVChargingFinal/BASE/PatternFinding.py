...
class PatternFinding(object):
    def __init__(self, contours_group, image):
        ...
        if not contours_group:
            ...
            self.AreaRatioLowerLimit = 1    #the lower limit of ratio of the outer square v.s to inner square
            self.AreaRatioUpperLimit = 30   #the upper limit of ratio of the outer square v.s to inner square
    ...
    def CheckingRatioOfContours(self, index):
        ...
        return ((areaoffirst / areaofsecondchild) > self.AreaRatioLowerLimit and \
                ((areaoffirst / areaofsecondchild) < self.AreaRatioUpperLimit))
